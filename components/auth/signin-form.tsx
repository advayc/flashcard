    ...
    <Card className="sky-card auth-card">
      <CardContent className="pt-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Button
            type="submit"
            className="w-full h-11 mt-6 bg-skyBlue hover:bg-skyBlue/90 text-white hover:shadow-[0_5px_15px_rgba(14,165,233,0.5)] transition-all duration-300 signin-button"
            disabled={isLoading || isGoogleLoading || isDiscordLoading}
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-6 text-center">
          <div className="mt-6 text-sm text-gray-400">
            ...
            <Link
              href="/signup"
              className="text-skyBlue hover:text-skyBlue/80 transition-colors font-medium signup-link"
            >
              Sign up
            </Link>
          </div>
